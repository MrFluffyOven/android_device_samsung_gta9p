...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := SRPWD25B001
...
BOARD_SYSTEMEXTIMAGE_PARTITION_SIZE := 0x1349B000
BOARD_VENDORIMAGE_PARTITION_SIZE := 0x3D244000
BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_BOOTIMAGE_FILE_SYSTEM_TYPE := emmc
BOARD_RECOVERYIMAGE_FILE_SYSTEM_TYPE := emmc
BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_PRODUCTIMAGE_FILE_SYSTEM_TYPE := erofs
BOARD_SYSTEMEXTIMAGE_FILE_SYSTEM_TYPE := erofs
